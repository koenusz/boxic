...
| Phase 9 — Compliance Phase                          | `in_progress` | The phase began from 1,177 published entries across 52 groups. WP-14 and WP-15 are complete, bringing the strict profiles to 1,461/3,545 entries across 72 groups (41.21% total-corpus coverage); 78 groups and 2,084 entries remain assigned to WP-16–WP-24. | Complete the remaining nine compliance work packages; publish every passing group and explicitly disposition platform-specific cases. |
...
| FEEL-09 | WP-07        | `done`        | All wholly WP-07-owned mapped groups pass and are enabled; after WP-12, WP-14, and WP-15 additions the refreshed pinned report publishes 1,384/1,384 passing cases with zero failures, unsupported, missing, or errors. |
...
| DMN-05  | WP-09        | `done`        | Official `0084-feel-for-loops` passes 24/24 end to end, including `decision_014` consuming the `days in weekend` decision; the group remains enabled in the current 1,384-case pinned FEEL profile. |
...
| COMP-02 | WP-14–WP-19  | `in_progress` | WP-14 and WP-15 contribute 284/284 newly published FEEL entries; complete WP-16–WP-19 and continue expanding the FEEL strict profile group-by-group. |
