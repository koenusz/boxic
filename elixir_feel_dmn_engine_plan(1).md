...
| Phase 9 — Compliance Phase                          | `in_progress` | The phase began from 1,177 published entries across 52 groups. WP-14–WP-17 are complete, bringing the strict profiles to 1,984/3,545 entries across 90 groups (55.97% total-corpus coverage); 60 groups and 1,561 entries remain assigned to WP-18–WP-24. | Complete the remaining seven compliance work packages; publish every passing group and explicitly disposition platform-specific cases. |
...
| FEEL-09 | WP-07        | `done`        | All wholly WP-07-owned mapped groups pass and are enabled; after WP-12 and WP-14–WP-17 additions the refreshed pinned report publishes 1,907/1,907 passing cases with zero failures, unsupported, missing, or errors. |
...
| DMN-05  | WP-09        | `done`        | Official `0084-feel-for-loops` passes 24/24 end to end, including `decision_014` consuming the `days in weekend` decision; the group remains enabled in the current 1,907-case pinned FEEL profile. |
...
| COMP-02 | WP-14–WP-19  | `in_progress` | WP-14–WP-17 contribute 807/807 newly published FEEL entries; complete WP-18–WP-19 and continue expanding the FEEL strict profile group-by-group. |
