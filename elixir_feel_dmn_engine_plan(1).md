...
| Phase 9 — Compliance Phase                          | `in_progress` | The phase began from 1,177 published entries across 52 groups. WP-14–WP-21 are complete, bringing the strict profiles to 3,392 supported entries across 129 passing groups (95.68% total-corpus coverage), plus 18 explicitly unsupported Java-interoperability entries in one platform-specific group; 20 groups and 135 entries remain assigned to WP-22–WP-24. | Complete the remaining three compliance work packages and publish every passing group. |
...
| WP-20        | `done` | Legacy lexical input coercion, punctuation-bearing DMN names, nested BKM dependencies, singleton-list promotion, collection functions/defaults, numeric comparison precision, and complete number/temporal/duration arithmetic are implemented. All 21 mapped groups pass 1,213/1,213 and the strict DMN profile passes 1,290/1,290. | None. |
...
| FEEL-09 | WP-07        | `done`        | All wholly WP-07-owned mapped groups pass and are enabled; after WP-12 and WP-14–WP-18 additions the refreshed pinned report publishes 2,042/2,042 passing cases with zero failures, unsupported, missing, or errors. |
...
| DMN-05  | WP-09        | `done`        | Official `0084-feel-for-loops` passes 24/24 end to end, including `decision_014` consuming the `days in weekend` decision; the group remains enabled in the current 2,042-case pinned FEEL profile. |
...
| COMP-03 | WP-20–WP-24  | `in_progress` | WP-20–WP-21 contribute 30 groups/1,273 passing entries to the strict DMN profile. Complete the remaining 20 groups/135 entries in WP-22–WP-24. |
...
| WP-17 | Types, coercion, predicates, and contexts | `0070-feel-instance-of`, `0071-feel-between`, `0073-feel-comments`, `0080-feel-getvalue-function`, `0081-feel-getentries-function`, `0082-feel-coercion`, `0103-feel-is-function`, `1145-feel-context-function`, `1146-feel-context-put-function`, `1147-feel-context-merge-function` | `354/354`; all enabled in the FEEL profile. | All ten groups remain fully passing. |
| WP-18 | Calendar, duration, intervals, and clocks | `0093-feel-at-literals`, `0095-feel-day-of-year-function`, `0096-feel-day-of-week-function`, `0097-feel-month-of-year-function`, `0098-feel-week-of-year-function`, `1121-feel-years-and-months-duration-function`, `1130-feel-interval`, `1148-feel-now-function`, `1149-feel-today-function` | `135/135`; all enabled in the FEEL profile. | All nine groups remain fully passing. |
