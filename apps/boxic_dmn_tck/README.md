...
Boxic runs on the BEAM and does not embed a JVM or provide a Java reflection
bridge. Boxic therefore provides an allowlisted Elixir external-function
...
reflection. Boxic consequently keeps the conformance result and the useful
...
- they do not reduce compatibility on Boxic's supported scope; and
...
[Boxic FEEL README](../boxic_feel/README.md#elixir-external-functions).
...
Boxic's supported platform contract.
